...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Albert+Sans:ital,wght@0,100..900;1,100..900&family=Nunito:ital,wght@0,200..1000;1,200..1000&family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap"
    rel="stylesheet" />
</head>
...
<body class="bg-body homepage post-template">
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
        ...
        >
          <g fill="none" stroke="currentColor" stroke-width="2">
            <path
              d="M3.34 17c2.76 4.783 8.876 6.42 13.66 3.66a9.96 9.96 0 0 0 4.196-4.731a9.99 9.99 0 0 0-.536-8.93a9.99 9.99 0 0 0-7.465-4.928A9.96 9.96 0 0 0 7 3.339C2.217 6.101.578 12.217 3.34 17Z"
            />
            <path
              stroke-linecap="round"
              d="M16.95 20.573S16.01 13.982 14 10.5S7.05 3.427 7.05 3.427"
            />
            <path
              stroke-linecap="round"
              d="M21.864 12.58c-5.411-1.187-12.805 3.768-14.287 8.238m8.837-17.609c-1.488 4.42-8.74 9.303-14.125 8.243"
            />
          </g>
        </symbol>
        <symbol
        ...
        >
          ...
          >
            <path
              d="M15 10c0-1.105-1.343-2-3-2s-3 .895-3 2s1.343 2 3 2s3 .895 3 2s-1.343 2-3 2s-3-.895-3-2"
            />
            <path
              d="M18 20a4 4 0 0 0 2.954-6.697c-.675-.739-.898-1.042-.986-2.026a7.97 7.97 0 0 0-2.311-4.934a8 8 0 0 0-8.054-1.977c-.943.295-1.31.205-2.254-.133a4 4 0 0 0-4.303 6.464c.675.739.898 1.042.986 2.026a7.97 7.97 0 0 0 2.311 4.934a8 8 0 0 0 8.054 1.977c.943-.295 1.31-.205 2.254.133c.421.15.875.233 1.349.233"
            />
          </g>
        </symbol>
        <symbol
  ...
  <div class="container-fluid">
    ...
    <header
        id="header-nav"
        class="col-lg-2 position-fixed px-5 bg-white h-100"
      >
        <div
          class="header-wrap d-flex flex-column justify-content-between h-100"
        >
          <div class="navigation">
            <div class="site-logo my-5 pb-5">
              <a href="index.html">
            ...
            <nav id="one-page-menu" class="vertical-menu my-5">
              <ul class="menu-list list-unstyled">
                ...
                <li class="pb-3">
                  <a href="#experience" class="nav-link text-uppercase"
                    >Portraits</a
                  >
                </li>
                <li class="pb-3">
                ...
                <li>
                  <a
                    class="nav-link btn-toggle d-flex justify-content-between align-items-center collapsed text-uppercase"
                  ...
                  <div id="pages-collapse" class="collapse">
                    <ul class="list-unstyled py-3">
                      ...
                      <li>
                        <a href="team.html"
                          >My Team <span class="badge bg-primary">PRO</span></a
                        >
                      </li>
                      <li>
                        <a href="blog.html"
                      ...
                      <li>
                        <a href="styles.html"
                          >Styles <span class="badge bg-primary">PRO</span></a
                        >
                      </li>
                    </ul>
                  </div>
                ...
                <div>
                  <a
                    href="https://templatesjungle.gumroad.com/l/will-fashion-photographer-free-bootstrap-html-website-template"
                    target="_blank" class="btn btn-dark get-pro text-uppercase rounded-5 py-3 px-4 mt-3"
                    >Get Pro
                    <svg
                      width="24"
                      height="24"
          ...
          <div class="mt-5">
            <div class="email-links">
              <a
                ...
                class="py-3 my-3 border-bottom border-black d-flex"
                >contact@yoursite.com</a
              >
            </div>
            <ul
              class="list-unstyled d-flex justify-content-start flex-wrap gap-2"
            >
              <li>
                <a href="#" class="fw-bold pe-1 social-link">
    ...
    <main class="col-lg-10 offset-lg-2">
      ...
      <header
        id="header-nav"
        class="navbar position-fixed w-100 pt-5 d-lg-block d-none"
      >
        <div class="container-fluid d-flex justify-content-end">
          ...
          >
            <svg width="24" height="24" class="navbar-icon text-black">
          ...
          >
            ...
            <div class="offcanvas-body">
              <header class="hero">
                <div class="container text-center align-content-between">
                  <div>
                    <img
                      src="images/artist.jpg"
                      class="hero-img mb-4 rounded-circle"
                    ...
                    <p>
                      ...
                      Quam risus nam ma aliquet. Libero porta in sodales.
                    </p>
                    <div class="social-icon my-2">
                      <ul
                        class="list-unstyled d-flex justify-content-center gap-2"
                      >
                        <li>
                          <a href="#" class="fw-bold pe-1 social-link">
                            <svg width="24" height="24" viewBox="0 0 24 24">
